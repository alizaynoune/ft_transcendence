...
import { ComponentType, SVGProps, useContext, useState, useEffect } from "react";
    ...
    return (
        <div className={style.container}>
            <div className={style.progressContainer}>
                ...
                />
                {isMyProfile && (
                    <Upload accept="image/*" showUploadList={false} onChange={handleChange} beforeUpload={() => false}>
                        <Button
